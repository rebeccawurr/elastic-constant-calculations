# -*- coding: utf-8 -*-
"""
Created on Mon Aug  1 19:57:00 2022

@author: user
"""

#TETRAGONAL 422, 4mm, -42m, 4/m 2/m, 2/m.
#METHOD #2 (Koizumi, et al (2006))
print('TETRAGONAL (422, 4mm, -42m, 4/m 2/m, 2/m) ELASTIC CONSTANT CALCULATIONS')
...
print('- Tested with velocities from Koizumi (2006) (3.097,1.518,1.448,3.149,1.505,3.197); density=1.290; theta=22.8')
...
c_44=rho*(v_2**2)
c_33=rho*(v_4**2)
c_66=(rho*(v_5**2)-(c_44*(np.cos(th))**2))/((np.sin(th))**2)
c_12=rho*(v_1**2-v_3**2)-c_66
c_11=rho*(v_1**2+v_3**2)-c_66
                ...
                for m in range(2):
                    ...
                    for n in range(2):
                        ...
                        for p in range(2):
                            ...
                            c_44a=rhoa*(v2a**2)
                            c_33a=rhoa*(v4a**2)
                            c_66a=(rhoa*(v5a**2)-(c_44a*(np.cos(th))**2))/((np.sin(th))**2)
                            c_12a=rhoa*(v1a**2-v3a**2)-c_66a
                            c_11a=rhoa*(v1a**2+v3a**2)-c_66a
